...
fun LoadingIndicator(
    ...
    val currentArcStartAngle by transition.animateValue(0,
        360,
        Int.VectorConverter,
    ...
    Dialog(onDismissRequest = {}) {
        Column(verticalArrangement = Arrangement.Center,
            ...
            Text(text = stringResource(id = R.string.waiting_for_player),
                color = Color.White,
                modifier = Modifier.padding(top = dimensionResource(id = R.dimen.padding_text_small)))
        }
    }
}